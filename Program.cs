...
#pragma warning disable CS8618
        ...
        static void RunWithOptions(Options opts)
        {
            ...
            using (ITraceProcessor trace = TraceProcessor.Create(opts.etlFileName, settings))
            {
                ...
                IPendingResult<ICpuSchedulingDataSource> pendingCpuSchedulingData =
                ...
                if (opts.listProcesses)
                {
                    ...
                    SortedSet<string> allProcesses = new SortedSet<string>();
                ...
                ICpuSchedulingDataSource cpuSchedData = pendingCpuSchedulingData.Result;
                ...
                for (int i = 0; i < cpuSchedData.ThreadActivity.Count; i++)
                {
